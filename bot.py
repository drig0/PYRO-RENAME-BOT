...
class Bot(Client):
    ...
    async def start(self):
        ...
        if Config.WEB_SUPPORT:
            ...
            await app.setup()
            port = int(os.environ.get("PORT", 8080))  # Pega o porto configurado pelo Heroku ou 8080 como padrão
            await web.TCPSite(app, "0.0.0.0", port).start()  # Usa o porto correto
